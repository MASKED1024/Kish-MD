...
let code = Config.sessionId.replace(/KISH-BOT;;;=>/g, "");
let code2 = Buffer.from(code, "base64").toString("utf-8")
let id = code2.replace(/KISH-BOT;;;=>/g,"");
...
printRainbowMessage();
    ...
    Kish.copyNForward = async (jid, message, forwardingScore = true, options = {}) => {
                let vtype
                ...
                m = generateWAMessageFromContent(jid, m, {
                    ...options,
                    userJid: Kish.user.jid
                })
                await Kish.relayMessage(jid, m.message, { messageId: m.key.id, additionalAttributes: { ...options } })
                return m
            };
